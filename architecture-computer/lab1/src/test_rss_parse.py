import unittest
from helper import read_xml_file, rss_parse, print_to_file, del_file, score_process
...
def test_score_process():
  srcString = "Soccer #Livescore: (SUI-CHL) #Rapperswil vs #FCWinterthur: 1-1. Goal for FC Winterthur"
